...
TRANSLATIONS: Dict[Language, Dict[str, str]] = {
    "zh": {
        ...
        "status_mock_mode": "⚠️ **模拟模式：** 未提供 API Token，将返回模拟结果。\n\n如需真实推理，请在 Generate 页输入 ModelScope API Token 并点击 Save Token。",
        "status_result": "### 生成结果",
        "status_mode": "**模式：** ",
        "status_mode_mock": "🎭 模拟模式（未提供有效 Token）",
        "status_mode_remote": "☁️ 远程推理",
        "status_mode_local": "📦 本地模拟",
        "status_mock_note": "_这是一个模拟结果。要获得真实的图像生成，请提供 ModelScope API Token。_",
        "status_job_id": "**任务 ID：** ",
        "status_model": "**使用模型：** ",
        "status_state": "**状态：** ",
        "status_warning_incomplete": "⚠️ **注意：** 模型 ID 可能不完整（缺少组织前缀）。如遇到 400 错误，请在 'API Model Override' 字段输入完整格式，例如 `black-forest-labs/FLUX.1-dev`",
        "status_job_error": "**⚠️ 警告：** ",
        "status_success": "✅ **成功！** 图像已生成，请在右侧查看。",
        "status_generated_count": "**生成的图片数量：** ",
        "status_no_images": "⚠️ **未返回图像**",
    ...
    "en": {
        ...
        "token_status_default": "**Status:** No token provided (will use mock mode)",
        "output_label": "Output",
        "results_label": "Generated outputs",
        "language": "Language",
        ...
        "status_mock_mode": "⚠️ **Mock Mode:** No API Token provided, will return mock results.\n\nFor real inference, please enter your ModelScope API Token in the Generate tab and click Save Token.",
        "status_result": "### Generation Result",
        "status_mode": "**Mode:** ",
        "status_mode_mock": "🎭 Mock Mode (No Valid Token)",
        "status_mode_remote": "☁️ Remote Inference",
        "status_mode_local": "📦 Local Mock",
        "status_mock_note": "_This is a mock result. To get real image generation, please provide a ModelScope API Token._",
        "status_job_id": "**Job ID:** ",
        "status_model": "**Model Used:** ",
        "status_state": "**Status:** ",
        "status_warning_incomplete": "⚠️ **Note:** Model ID may be incomplete (missing organization prefix). If you encounter a 400 error, please enter the full format in 'API Model Override', e.g. `black-forest-labs/FLUX.1-dev`",
        "status_job_error": "**⚠️ Warning:** ",
        "status_success": "✅ **Success!** Image generated, see results on the right.",
        "status_generated_count": "**Number of images generated:** ",
        "status_no_images": "⚠️ **No images returned**",
